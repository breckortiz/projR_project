...
namespace LibSM64
{
    public class SM64Mario : MonoBehaviour
    {
        ...
        [SerializeField] GameObject MarioPuppet = null;

        [SerializeField] bool hideMario = true;
        ...
        public void contextFixedUpdate()
        {
            ...
            if(marioMesh.colors.Length != 0 && marioMesh.uv.Length != 0)
            {
        ...
        public void contextUpdate()
        {
            ...
            //current way to make mario invis, this is currently ineficient as we are building mario and then deleting the build. just a place holder
            //if (hideMario)
            {
                //marioMesh.Clear();
                MarioPuppet.SetActive(true);
            }
            //else
            {
                //MarioPuppet.SetActive(false);
            }
        }
